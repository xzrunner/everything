...
TEST_CASE("attribute create")
{
    ...
    test::check_attr_value(attr_create, sop::GeoAttrClass::Point, "new_attr", 0, dag::Variable(0.1f));
}
...
TEST_CASE("attribute promote")
{
    ...
    SECTION("vertex to point")
    {
        ...
        test::check_attr_value(attr_create, sop::GeoAttrClass::Vertex, "new_attr", 0, dag::Variable(0.1f));
        ...
        test::check_attr_value(attr_promote, sop::GeoAttrClass::Point, "new_attr", 0, dag::Variable(0.1f));
    }
    ...
    SECTION("point to vertex")
    {
        ...
        test::check_attr_value(attr_promote, sop::GeoAttrClass::Vertex, "new_attr", 0, dag::Variable(0.1f));
    }
}
...
TEST_CASE("attribute transfer")
{
    ...
    SECTION("add new one")
    {
        ...
        test::check_attr_value(attr_transfer, sop::GeoAttrClass::Point, "new_attr", 0, dag::Variable(0.1f));
    }
    ...
    SECTION("change old")
    {
        ...
        test::check_attr_value(attr_create_t, sop::GeoAttrClass::Point, "new_attr", 0, dag::Variable(0.2f));
...
TEST_CASE("attribute wrangle")
{
    ...
    test::check_attr_value(normal, sop::GeoAttrClass::Point, sop::GeoAttrNames[sop::GEO_ATTR_NORM], 2, dag::Variable(sm::vec3(0, 1, 0)));
    test::check_attr_count(attr_wrangle, sop::GeoAttrClass::Point, sop::GeoAttrNames[sop::GEO_ATTR_NORM], 4);
    test::check_attr_value(attr_wrangle, sop::GeoAttrClass::Point, sop::GeoAttrNames[sop::GEO_ATTR_NORM], 2, dag::Variable(sm::vec3(0, 1, 0)));
    test::check_attr_count(attr_wrangle, sop::GeoAttrClass::Point, sop::GeoAttrNames[sop::GEO_ATTR_UP], 4);
    test::check_attr_value(attr_wrangle, sop::GeoAttrClass::Point, sop::GeoAttrNames[sop::GEO_ATTR_UP], 1, dag::Variable(sm::vec3(0, 1, 0)));
}
...
TEST_CASE("measure box")
{
    ...
    SECTION("perimeter")
    {
        ...
        test::check_attr_value(measure, sop::GeoAttrClass::Primitive, "perimeter", 3, dag::Variable(4.0f));
    }
    ...
    SECTION("area")
    {
        ...
        test::check_attr_value(measure, sop::GeoAttrClass::Primitive, "area", 2, dag::Variable(1.0f));
    }
}
...
TEST_CASE("measure polyline")
{
    ...
    SECTION("perimeter")
    {
        ...
        test::check_attr_value(measure, sop::GeoAttrClass::Primitive, "perimeter", 0, dag::Variable(3.0f));
    }
    ...
    SECTION("area")
    {
        ...
        test::check_attr_value(measure, sop::GeoAttrClass::Primitive, "area", 0, dag::Variable(0.0f));
    }
}
...
TEST_CASE("measure rename")
{
    ...
    SECTION("perimeter")
    {
        ...
        test::check_attr_value(measure, sop::GeoAttrClass::Primitive, "test0", 3, dag::Variable(4.0f));
    }
    ...
    SECTION("area")
    {
        ...
        test::check_attr_value(measure, sop::GeoAttrClass::Primitive, "test1", 2, dag::Variable(1.0f));
    }
}
