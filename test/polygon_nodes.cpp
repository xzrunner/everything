...
TEST_CASE("add to brush with attr")
{
    ...
    test::check_attr_value(add, sop::GeoAttrClass::Point, sop::GeoAttrNames[sop::GEO_ATTR_CD], 2, dag::Variable(sm::vec3(0.3f, 0.4f, 0.5f)));
    test::check_attr_value(add, sop::GeoAttrClass::Point, sop::GeoAttrNames[sop::GEO_ATTR_CD], 6, dag::Variable(sm::vec3(0.3f, 0.4f, 0.5f)));
    test::check_attr_value(add, sop::GeoAttrClass::Point, sop::GeoAttrNames[sop::GEO_ATTR_CD], 7, dag::Variable(sm::vec3(0.3f, 0.4f, 0.5f)));
    test::check_attr_value(add, sop::GeoAttrClass::Point, sop::GeoAttrNames[sop::GEO_ATTR_CD], 8, dag::Variable(sm::vec3(0, 0, 0)));
    test::check_attr_value(add, sop::GeoAttrClass::Point, sop::GeoAttrNames[sop::GEO_ATTR_CD], 9, dag::Variable(sm::vec3(0, 0, 0)));
}
...
TEST_CASE("add to shape with attr")
{
    ...
    test::check_attr_value(add, sop::GeoAttrClass::Point, sop::GeoAttrNames[sop::GEO_ATTR_CD], 0, dag::Variable(sm::vec3(0.3f, 0.4f, 0.5f)));
    test::check_attr_value(add, sop::GeoAttrClass::Point, sop::GeoAttrNames[sop::GEO_ATTR_CD], 1, dag::Variable(sm::vec3(0.3f, 0.4f, 0.5f)));
    test::check_attr_value(add, sop::GeoAttrClass::Point, sop::GeoAttrNames[sop::GEO_ATTR_CD], 2, dag::Variable(sm::vec3(0, 0, 0)));
    test::check_attr_value(add, sop::GeoAttrClass::Point, sop::GeoAttrNames[sop::GEO_ATTR_CD], 3, dag::Variable(sm::vec3(0, 0, 0)));
}
...
TEST_CASE("fuse polyline")
{
    ...
    test::check_attr_value(fuse, sop::GeoAttrClass::Point, sop::GeoAttrNames[sop::GEO_ATTR_CD], 0, dag::Variable(sm::vec3(1, 0, 0)));
}
...
TEST_CASE("normal box")
{
    ...
    SECTION("add to detail")
    {
        ...
        test::check_attr_value(normal, sop::GeoAttrClass::Detail, sop::GeoAttrNames[sop::GEO_ATTR_NORM], 0, dag::Variable(sm::vec3(0, 0, 0)));
    }
}
...
TEST_CASE("normal plane")
{
    ...
    SECTION("add to point")
    {
        ...
        for (int i = 0; i < 4; ++i) {
            test::check_attr_value(normal, sop::GeoAttrClass::Point, sop::GeoAttrNames[sop::GEO_ATTR_NORM], i, dag::Variable(sm::vec3(0, 1, 0)));
        }
    }
    ...
    SECTION("add to vertex")
    {
        ...
        for (int i = 0; i < 4; ++i) {
            test::check_attr_value(normal, sop::GeoAttrClass::Vertex, sop::GeoAttrNames[sop::GEO_ATTR_NORM], i, dag::Variable(sm::vec3(0, 1, 0)));
        }
    }
    ...
    SECTION("add to primitive")
    {
        ...
        test::check_attr_value(normal, sop::GeoAttrClass::Primitive, sop::GeoAttrNames[sop::GEO_ATTR_NORM], 0, dag::Variable(sm::vec3(0, 1, 0)));
    }
    ...
    SECTION("add to detail")
    {
        ...
        test::check_attr_count(normal, sop::GeoAttrClass::Detail, sop::GeoAttrNames[sop::GEO_ATTR_NORM], 1);
        test::check_attr_value(normal, sop::GeoAttrClass::Detail, sop::GeoAttrNames[sop::GEO_ATTR_NORM], 0, dag::Variable(sm::vec3(0, 1, 0)));
    }
}
...
TEST_CASE("normal line")
{
    ...
    SECTION("add to point")
    {
        ...
        for (int i = 0; i < n; ++i) {
            test::check_attr_value(normal, sop::GeoAttrClass::Point, sop::GeoAttrNames[sop::GEO_ATTR_NORM], i, dag::Variable(sm::vec3(0, 0, 0)));
        }
    }
    ...
    SECTION("add to vertex")
    {
        ...
        for (int i = 0; i < n; ++i) {
            test::check_attr_value(normal, sop::GeoAttrClass::Vertex, sop::GeoAttrNames[sop::GEO_ATTR_NORM], i, dag::Variable(sm::vec3(0, 0, 0)));
        }
    }
    ...
    SECTION("add to primitive")
    {
        ...
        test::check_attr_count(normal, sop::GeoAttrClass::Primitive, sop::GeoAttrNames[sop::GEO_ATTR_NORM], 1);
        test::check_attr_value(normal, sop::GeoAttrClass::Primitive, sop::GeoAttrNames[sop::GEO_ATTR_NORM], 0, dag::Variable(sm::vec3(0, 0, 0)));
    }
...
TEST_CASE("poly fill")
{
    ...
    SECTION("point attr rebuild")
    {
        ...
        test::check_attr_value(poly_fill, sop::GeoAttrClass::Point, sop::GeoAttrNames[sop::GEO_ATTR_CD], 2, dag::Variable(sm::vec3(0.3f, 0.4f, 0.5f)));
        test::check_attr_value(poly_fill, sop::GeoAttrClass::Point, sop::GeoAttrNames[sop::GEO_ATTR_CD], 5, dag::Variable(sm::vec3(0.3f, 0.4f, 0.5f)));
        test::check_attr_value(poly_fill, sop::GeoAttrClass::Point, sop::GeoAttrNames[sop::GEO_ATTR_CD], 6, dag::Variable(sm::vec3(0.3f, 0.4f, 0.5f)));
    }
    ...
    SECTION("vertex attr rebuild")
    {
        ...
        test::check_attr_value(poly_fill, sop::GeoAttrClass::Vertex, sop::GeoAttrNames[sop::GEO_ATTR_CD], 2, dag::Variable(sm::vec3(0.3f, 0.4f, 0.5f)));
        test::check_attr_value(poly_fill, sop::GeoAttrClass::Vertex, sop::GeoAttrNames[sop::GEO_ATTR_CD], 5, dag::Variable(sm::vec3(0.3f, 0.4f, 0.5f)));
        test::check_attr_value(poly_fill, sop::GeoAttrClass::Vertex, sop::GeoAttrNames[sop::GEO_ATTR_CD], 6, dag::Variable(sm::vec3(0.3f, 0.4f, 0.5f)));
    }
    ...
    SECTION("primitive attr rebuild")
    {
        ...
        test::check_attr_value(poly_fill, sop::GeoAttrClass::Primitive, sop::GeoAttrNames[sop::GEO_ATTR_CD], 1, dag::Variable(sm::vec3(0.3f, 0.4f, 0.5f)));
        test::check_attr_value(poly_fill, sop::GeoAttrClass::Primitive, sop::GeoAttrNames[sop::GEO_ATTR_CD], 3, dag::Variable(sm::vec3(0.3f, 0.4f, 0.5f)));
        test::check_attr_value(poly_fill, sop::GeoAttrClass::Primitive, sop::GeoAttrNames[sop::GEO_ATTR_CD], 4, dag::Variable(sm::vec3(0.3f, 0.4f, 0.5f)));
        test::check_attr_value(poly_fill, sop::GeoAttrClass::Primitive, sop::GeoAttrNames[sop::GEO_ATTR_CD], 5, dag::Variable(sm::vec3(0, 0, 0)));
    }
    ...
    SECTION("detail attr rebuild")
    {
        ...
        test::check_attr_value(poly_fill, sop::GeoAttrClass::Detail, sop::GeoAttrNames[sop::GEO_ATTR_CD], 0, dag::Variable(sm::vec3(0.3f, 0.4f, 0.5f)));
    }
}
...
TEST_CASE("poly frame shape(2 pts)")
{
    ...
    test::check_attr_value(polyframe, sop::GeoAttrClass::Point, "N", 0, dag::Variable(sm::vec3(0, 0, 0)));
    test::check_attr_value(polyframe, sop::GeoAttrClass::Point, "N", 1, dag::Variable(sm::vec3(0, 0, 0)));
    test::check_attr_value(polyframe, sop::GeoAttrClass::Point, "T", 0, dag::Variable(sm::vec3(-0.267261f, -0.534522f, -0.801784f)), true);
    test::check_attr_value(polyframe, sop::GeoAttrClass::Point, "T", 1, dag::Variable(sm::vec3(-0.267261f, -0.534522f, -0.801784f)), true);
    test::check_attr_value(polyframe, sop::GeoAttrClass::Point, "B", 0, dag::Variable(sm::vec3(0, 0, 0)));
    test::check_attr_value(polyframe, sop::GeoAttrClass::Point, "B", 1, dag::Variable(sm::vec3(0, 0, 0)));
}
...
TEST_CASE("poly frame shape - norm attr (2 pts)")
{
    ...
    test::check_attr_value(polyframe, sop::GeoAttrClass::Point, "N", 0, dag::Variable(sm::vec3(-0.57735f, 0.57735f, -0.57735f)), true);
    test::check_attr_value(polyframe, sop::GeoAttrClass::Point, "N", 1, dag::Variable(sm::vec3(-0.57735f, 0.57735f, 0.57735f)), true);
    test::check_attr_value(polyframe, sop::GeoAttrClass::Point, "T", 0, dag::Variable(sm::vec3(0, 0, -1)));
    test::check_attr_value(polyframe, sop::GeoAttrClass::Point, "T", 1, dag::Variable(sm::vec3(0, 0, -1)));
    test::check_attr_value(polyframe, sop::GeoAttrClass::Point, "B", 0, dag::Variable(sm::vec3(0.57735f, 0.57735f, 0)), true);
    test::check_attr_value(polyframe, sop::GeoAttrClass::Point, "B", 1, dag::Variable(sm::vec3(0.57735f, 0.57735f, 0)), true);
}
...
TEST_CASE("poly frame shape - calc norm (3 pts)")
{
    ...
    SECTION("style first edge")
    {
        ...
        test::check_attr_value(polyframe, sop::GeoAttrClass::Point, "N", 0, dag::Variable(sm::vec3(-0.707107f, 0.707107f, 0.0f)), true);
        test::check_attr_value(polyframe, sop::GeoAttrClass::Point, "N", 1, dag::Variable(sm::vec3(-0.707107f, 0.707107f, 0.0f)), true);
        test::check_attr_value(polyframe, sop::GeoAttrClass::Point, "N", 2, dag::Variable(sm::vec3(-0.707107f, 0.707107f, 0.0f)), true);
        test::check_attr_value(polyframe, sop::GeoAttrClass::Point, "T", 0, dag::Variable(sm::vec3(-0.57735f, -0.57735f, -0.57735f)), true);
        test::check_attr_value(polyframe, sop::GeoAttrClass::Point, "T", 1, dag::Variable(sm::vec3(-0.57735f, -0.57735f, -0.57735f)), true);
        test::check_attr_value(polyframe, sop::GeoAttrClass::Point, "T", 2, dag::Variable(sm::vec3(0.57735f, 0.57735f, -0.57735f)), true);
        test::check_attr_value(polyframe, sop::GeoAttrClass::Point, "B", 0, dag::Variable(sm::vec3(0.408248f, 0.408248f, -0.816497f)), true);
        test::check_attr_value(polyframe, sop::GeoAttrClass::Point, "B", 1, dag::Variable(sm::vec3(0.408248f, 0.408248f, -0.816497f)), true);
        test::check_attr_value(polyframe, sop::GeoAttrClass::Point, "B", 2, dag::Variable(sm::vec3(0.408248f, 0.408248f, 0.816497f)), true);
    }
    ...
    SECTION("style two edges")
    {
        ...
        test::check_attr_value(polyframe, sop::GeoAttrClass::Point, "N", 2, dag::Variable(sm::vec3(-0.707107f, 0.707107f, 0.0f)), true);
        test::check_attr_value(polyframe, sop::GeoAttrClass::Point, "T", 0, dag::Variable(sm::vec3(-0.57735f, -0.57735f, -0.57735f)), true);
        test::check_attr_value(polyframe, sop::GeoAttrClass::Point, "T", 1, dag::Variable(sm::vec3(0, 0, -1)), true);
        test::check_attr_value(polyframe, sop::GeoAttrClass::Point, "T", 2, dag::Variable(sm::vec3(0.57735f, 0.57735f, -0.57735f)), true);
        test::check_attr_value(polyframe, sop::GeoAttrClass::Point, "B", 0, dag::Variable(sm::vec3(0.408248f, 0.408248f, -0.816497f)), true);
        test::check_attr_value(polyframe, sop::GeoAttrClass::Point, "B", 1, dag::Variable(sm::vec3(0.707107f, 0.707107f, 0.0f)), true);
        test::check_attr_value(polyframe, sop::GeoAttrClass::Point, "B", 2, dag::Variable(sm::vec3(0.408248f, 0.408248f, 0.816497f)), true);
...
//    test::check_attr_value(polyframe, sop::GeoAttrClass::Point, "N", 0, dag::Variable(sm::vec3(0, -1, 0)));
//}