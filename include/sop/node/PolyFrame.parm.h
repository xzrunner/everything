...
PARAM_INFO(NormalNameToggle,    Boolean, Non,        m_normal_name_toggle,    (true))
PARAM_INFO(TangentNameToggle,   Boolean, tangentuon, m_tangent_name_toggle,   (true))
PARAM_INFO(BitangentNameToggle, Boolean, tangentvon, m_bitangent_name_toggle, (false))
